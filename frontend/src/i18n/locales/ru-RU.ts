export default {
  ...
  chat: {
    ...
    exportSessionId: 'ID сеанса',
    exportGeneratedAt: 'Время экспорта',
    exportRoleUser: 'Пользователь',
    exportRoleAssistant: 'Ассистент',
    exportMentions: 'Упоминания',
    exportEmptyAssistant: '(пусто)',
    exportEmpty: 'В этой сессии нет содержимого для экспорта',
    exportSuccess: 'Экспорт успешно выполнен',
    exportFailed: 'Ошибка экспорта, попробуйте снова',
    exportPopupBlocked: 'Браузер заблокировал всплывающее окно. Разрешите всплывающие окна и повторите.',
    exportPDFTip: 'Открылось окно печати. Выберите «Сохранить как PDF».',
