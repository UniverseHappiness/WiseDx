export default {
  ...
  chat: {
    ...
    exportPDF: "PDF로 내보내기",
    exportSessionId: "세션 ID",
    exportGeneratedAt: "내보낸 시간",
    exportRoleUser: "사용자",
    exportRoleAssistant: "어시스턴트",
    exportMentions: "멘션",
    exportEmptyAssistant: "(비어 있음)",
    exportEmpty: "이 세션에는 내보낼 내용이 없습니다",
    exportSuccess: "내보내기 성공",
    exportFailed: "내보내기 실패, 다시 시도하세요",
    exportPopupBlocked: "브라우저가 팝업을 차단했습니다. 팝업을 허용한 후 다시 시도하세요.",
    exportPDFTip: "인쇄 창이 열렸습니다. \"PDF로 저장\"을 선택하세요.",
