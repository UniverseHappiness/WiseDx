export default {
  ...
  agent: {
    ...
    noCollectedData: 'No collected data yet',
  ...
  retrievalTest: {
    ...
    description: 'Test hybrid retrieval for knowledge bases, for development debugging and parameter tuning',
    selectKnowledgeBase: 'Select Knowledge Base',
    selectKnowledgeBaseDesc: 'Select the knowledge base to test retrieval',
    selectKnowledgeBasePlaceholder: 'Select a knowledge base...',
    queryText: 'Query Text',
    queryPlaceholder: 'Enter the content to search...',
    embeddingModel: 'Embedding Model',
    embeddingModelDesc: 'Select embedding model for vector retrieval, leave empty to use knowledge base default',
    rerankModel: 'Rerank Model',
    rerankModelDesc: 'Select model for result reranking, leave empty to skip reranking',
    useDefaultModel: 'Use default model',
    noRerank: 'No reranking',
    paramConfig: 'Parameter Configuration',
    vectorThreshold: 'Vector Threshold',
    keywordThreshold: 'Keyword Threshold',
    matchCount: 'Top K Results',
    rerankThreshold: 'Rerank Threshold',
    rerankTopK: 'Rerank Top K',
    disableVectorMatch: 'Disable Vector Match',
    disableKeywordsMatch: 'Disable Keyword Match',
    search: 'Search',
    searching: 'Searching...',
...
\
  ...
  chat: {
    ...
    exportMentions: 'Mentions',
    exportEmptyAssistant: '(empty)',
    exportEmpty: 'No content to export in this session',
    exportSuccess: 'Export succeeded',
    exportFailed: 'Export failed, please try again',
    exportPopupBlocked: 'Popup was blocked by the browser. Please allow popups and retry.',
    exportPDFTip: 'Print dialog opened. Choose "Save as PDF".',
