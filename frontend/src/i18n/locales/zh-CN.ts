export default {
  ...
  chat: {
    ...
    exportPDF: "导出为 PDF",
    exportSessionId: "会话ID",
    exportGeneratedAt: "导出时间",
    exportRoleUser: "用户",
    exportRoleAssistant: "助手",
    exportMentions: "提及",
    exportEmptyAssistant: "（无内容）",
    exportEmpty: "当前会话暂无可导出的内容",
    exportSuccess: "导出成功",
    exportFailed: "导出失败，请重试",
    exportPopupBlocked: "弹窗被浏览器拦截，请允许弹窗后重试",
    exportPDFTip: "已打开打印窗口，请选择“另存为 PDF”",
  ...
  retrievalTest: {
    title: "检索测试",
    description: "测试知识库的混合检索功能，用于开发调试和参数调优",
    selectKnowledgeBase: "选择知识库",
    selectKnowledgeBaseDesc: "选择要测试检索的知识库",
    selectKnowledgeBasePlaceholder: "请选择知识库...",
    queryText: "查询文本",
    queryPlaceholder: "请输入要检索的内容...",
    embeddingModel: "Embedding模型",
    embeddingModelDesc: "选择用于向量检索的嵌入模型，留空则使用知识库默认模型",
    rerankModel: "Rerank模型",
    rerankModelDesc: "选择用于结果重排序的模型，留空则不进行重排序",
    ...
    matchCount: "最大返回数",
    rerankThreshold: "Rerank阈值",
    rerankTopK: "Rerank TopK",
    disableVectorMatch: "禁用向量匹配",
    disableKeywordsMatch: "禁用关键词匹配",
    search: "搜索",
    searching: "搜索中...",
    results: "搜索结果",
    noResults: "未找到匹配的内容",
  ...
  platform: {
    subtitle: "慧诊RAG智能检索系统",
    description: "让复杂文档理解与精准检索变得简单",
    rag: "RAG 增强生成",
    hybridSearch: "混合检索",
    localDeploy: "本地部署",
    multimodalParsing: "多模态医学文档解析",
    hybridSearchEngine: "医学知识混合检索",
    ragQandA: "医学循证智能问答",
