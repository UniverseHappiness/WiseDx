<template>
  <div class="login-layout">
    ...
    <!-- Logo - Top Left -->
    <a href="https://github.com/UniverseHappiness/WiseDx" target="_blank" class="header-logo" :title="$t('common.github')">
      <img src="@/assets/img/wisedx.png" alt="WeKnora" class="logo-image" />
    </a>

    <!-- Header Links - Top Right -->
    <div class="header-links">
      <a href="https://github.com/UniverseHappiness/WiseDx/wiki" target="_blank" class="header-link" :title="$t('common.website')">
      ...
      <a href="https://github.com/UniverseHappiness/WiseDx" target="_blank" class="header-link" :title="$t('common.info')">
