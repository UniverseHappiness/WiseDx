...
EOF
    ...
    "ldflags")
        # 输出Go ldflags格式
        echo "-X 'github.com/UniverseHappiness/WiseDx/internal/handler.Version=$VERSION' -X 'github.com/UniverseHappiness/WiseDx/internal/handler.CommitID=$COMMIT_ID' -X 'github.com/UniverseHappiness/WiseDx/internal/handler.BuildTime=$BUILD_TIME' -X 'github.com/UniverseHappiness/WiseDx/internal/handler.GoVersion=$GO_VERSION'"
        ;;
    "info")
        # 输出信息格式
        echo "版本信息: $VERSION"
